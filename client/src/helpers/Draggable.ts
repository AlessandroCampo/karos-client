...
export const handleDragStart = (event: Interact.InteractEvent) => {
...
export const handleDragMove = (event: Interact.InteractEvent) => {
    const target = event.target as HTMLElement;
...
export const handleDragEnd = (event: Interact.InteractEvent) => {
...
export const handleDrop = (event: Interact.InteractEvent) => {
